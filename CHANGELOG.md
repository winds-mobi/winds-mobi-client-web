...
- The station panel's header and content have slightly tighter padding on mobile.

### Fixed

- Scrolling the station panel's content on mobile (e.g. the wind/air history charts) no longer sometimes closes the panel by accident.
