...
module('Integration | Component | relative-time', function (hooks) {
  ...
  test('it formats epoch seconds safely', async function (assert) {
  ...
  test('it formats epoch milliseconds safely', async function (assert) {
  ...
  test('it falls back when timestamp is invalid', async function (assert) {
